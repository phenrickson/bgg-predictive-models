...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train/Tune/Test Users Rated Regression Model")
    ...
    parser.add_argument("--experiment", type=str, 
                       default="users_rated_regression")
...
def main():
    ...
    # Compute additional metrics on original scale
    test_metrics['mse_original_scale'] = mean_squared_error(test_actual, test_predictions)
    test_metrics['mae_original_scale'] = mean_absolute_error(test_actual, test_predictions)
