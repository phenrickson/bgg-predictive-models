...
def summarize_missingness(
    ...
    high_missing_cols = miss_df.filter(pl.col("missing_percent") > 50)["column"].to_list()
    ...
    return {
        ...
        "percent_columns_with_missing": round(columns_with_missing / total_columns * 100, 2) if total_columns > 0 else 0,
