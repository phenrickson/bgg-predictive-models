...
model. Filtered to games published in the last year or later. The
**Status** column shows whether the game is already in the user's
collection.
...
# Own > Wishlist > Want > Preordered > Prev. Owned > —.
