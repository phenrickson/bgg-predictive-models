...
if os.environ.get("BGG_REPORT_FIXTURE") == "1":
...
Older games that the model liked for the user during training/evaluation. These are the highest scoring games that the user does not currently own; these might be useful ones to check out.

::: {.column-margin} 
What older games should the user check out?
:::
