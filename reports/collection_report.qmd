...
::: {.column-margin}
TODO: notes about which feature families matter most for this user,
...
::: {.column-margin}
TODO: notes about training-set top picks. Where the model is most
confident, any obvious patterns or surprises.
:::
...
::: {.column-margin}
TODO: notes about how the model's preferences shift across years —
which years it nailed, which it whiffed, any genres that come and go.
:::
...
::: {.column-margin}
TODO: notes about older recommendations — gems the model picked out
