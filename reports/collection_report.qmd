...
::: {.column-margin}
Coefficients are on the log-odds scale. A coefficient of 0.05 on a
feature shifts the log-odds of ownership by 0.05 when that feature is
present, holding everything else constant.
:::
